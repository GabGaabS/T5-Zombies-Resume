...
'@
    ...
    return "// T5ZR_MENU_OVERRIDE v0.8.0-beta.21 - generated from Plutonium client-raw-assets $MenuUpstreamCommit`n" + $menu
}
...
Write-Host "[T5ZR] beta.21 utilise le runtime beta.19 valide; adapter monde beta.20 retire temporairement."
Write-Host ""
